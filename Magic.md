...
|------|-----|----------|--------|--------|
|Earth|Stone, Metal, Endurance, Gravity|Air|Unregulated||
|Air|Wind, Sound, Electricity, Mobility|Earth|Unregulated||
...
|----------|------|-----------|--------|
|Bolt|Elemental (Any)|A basic offensive spell that launches a concentrated projectile of elemental energy at a target.|Common starting spell for many mages.|
|Elemental Shield|Elemental (Any)|Creates a protective barrier of the given element around the caster or an ally, deflecting incoming attacks. Especially effective against opposing elements.|Useful for defense in combat.|
|Summon Elemental|Elemental (Any)|Summons a elemental creature to aid the caster the power of the elemental is based on the caster's power.|Elementals will serve for one year or until a specific condition is met.|
|Elemental Fury|Elemental (Any)|Unleashes a powerful rain of elemental energy, causing widespread damage in an area.|Requires significant magical power to cast.|

### Light
|Spell Name|School|Description|Comments|
|----------|------|-----------|--------|
|Heal|Light|Greatly restores health to the target.|Widely used by healers and clerics.|
|Cure|Light|Removes poisons, diseases, and other ailments from the target.|Essential for adventurers facing various hazards.|
|Light|Light|Creates a bright light source, illuminating dark areas.|Useful for exploration and visibility.|
|Purify|Light|Cleanses food, water, or an area of toxins and contaminants.|Essential for survival in hazardous environments.|
|Bless|Light|Grants a target increased resilience and luck, improving their chances of success in various tasks.|Commonly used to bolster allies before battle.|
|Summon Archon|Light|Summons a powerful celestial being to aid the caster.|Frequently frowned upon by the clergy for bothering celestial beings.|
|Holy Fire|Light|Calls down a pillar of divine fire that damages undead and evil-aligned creatures.|Effective against dark and evil foes.|
|Sanctuary|Light|Creates a protective area where hostile actions are prohibited.|Often used to create safe zones during conflicts.|
...
|Spell Name|School|Description|Comments|
|----------|------|-----------|--------|
|Gravity Well|Earth|Creates a localized area of increased gravity, pulling objects and creatures towards a central point.|Useful for crowd control and battlefield manipulation.|
|Stone Skin|Earth|Hardens the caster's skin to the toughness of stone, providing increased protection.|Useful for defense in combat.|
|Earthquake|Earth|Causes the ground to shake violently, knocking down and disorienting creatures in the area.|Requires significant magical power to cast.|
|Entomb|Earth|Encases a target in solid earth or stone, immobilizing them.|Useful for capturing or restraining enemies.|
|Entangle|Earth|Causes plants or roots to grow rapidly, ensnaring and immobilizing a target.|Useful for crowd control and battlefield manipulation.|
|Dig|Earth|Allows the caster to tunnel through earth and stone.|Useful for escape or infiltration.|
|Wall of Stone|Earth|Creates a solid wall of stone that can be used for defense or to block passage.|Useful for creating barriers and fortifications.|

### Air
|Spell Name|School|Description|Comments|
|----------|------|-----------|--------|
|Flight|Air|Allows the caster to levitate or fly for a short duration.|Useful for exploration and evasion.|
|Gust|Air|Creates a powerful blast of wind that can knock back enemies or objects.|Useful for crowd control and battlefield manipulation.|
|Lightning Bolt|Air|A stronger variation of the common bolt spell, dealing significant damage and potentially stunning the target, may arc to nearby targets.|Common offensive spell.|
|Invisibility|Air|Renders the caster or a target invisible for a short duration.|Useful for stealth and escape.|
|Invisible Servant|Air|Creates an invisible, very limited form of air elemental that can perform simple tasks for the caster. The servant will dissipate after a short time or if it takes any damage.|Useful for utility and convenience.|
|Muffle Sound|Air|Dampens sound in a small area, making it difficult to hear anything within or from outside the area.|Useful for stealth and secrecy.|

### Fire
|Spell Name|School|Description|Comments|
|----------|------|-----------|--------|
|Ignite|Fire|Sets a target ablaze, causing ongoing fire damage.|Common offensive spell.|
|Fireball|Fire|A higher powered version of the bolt of fire spell dealing damage in a roughly 5 meter spherical area.|Requires significant magical power to cast.|
|Flame Shield|Fire|Creates a protective barrier of flames around the caster or an ally.|Useful for defense and protection.|
|Combustion|Fire|Causes a significantly weaker target to explode in a burst of flames, dealing significant damage to nearby creatures.|Useful for crowd control and battlefield manipulation.|
|Wall of Fire|Fire|Creates a wall of intense flames that damages anyone who passes through it.|Useful for creating barriers and fortifications.|
|Meteor Shower|Fire|Calls down a rain of fiery meteors that strike multiple targets in an area.|Requires significant magical power to cast.|
|Desicate|Fire|Dries out moisture from a target, causing dehydration and weakening them.|Useful for weakening enemies.|

### Water
|Spell Name|School|Description|Comments|
|----------|------|-----------|--------|
|Mend|Water|Simple Healing|Repairs minor wounds, injuries and bleeding on a target.|Widely used by healers and adventurers.|
|Freeze|Water|Encases a target in ice,
immobilizing them temporarily.|Useful for crowd control and battlefield manipulation.|
|Drown|Water|Creates a bubble of water around a target, making it difficult for them to breathe.|Useful for incapacitating enemies.|
|Tidal Wave|Water|Summons a large wave of water that crashes down on an area, knocking back and damaging creatures. Requires a significant amount of water to be present.|Requires significant magical power to cast.|
|Torrential Rain|Water|Summons a storm that brings heavy rain, strong winds to an area.|Requires significant magical power to cast.|
|Water Breathing|Water|Allows the caster or a target to breathe underwater for a limited time.|Useful for underwater exploration.|
...
|Spell Name|School|Description|Comments|
|----------|------|-----------|--------|
|Telekinesis|Aether|Allows the caster to move objects with their mind.|Useful for manipulating objects at a distance.|
|Enchant Item|Aether|Imbues an item with magical properties or enhancements.|Commonly used by enchanters and artificers.|
|Teleport|Aether|Allows the caster to instantly transport themselves or others to a known location.|Requires knowledge of the destination.|
