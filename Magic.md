...
|------|-----|----------|--------|--------|
|Stone, Metal, Endurance, Gravity|Unregulated||
|Wind, Sound, Electricity, Mobility|Unregulated||
|Heat, Combustion, Energy, Destruction|Unregulated||
|Liquids, Ice, Simple Healing/Mending, Flow|Unregulated||
|Ephemeral, Enchantment, Spiritual Essence||Unregulated| |
|Healing, Holy, Radiant Energy|Unregulated|Light magic is often perceived as "holy" or "good".
|Unholy, Corruption, Undeath, Shadow|Regulated|Dark magic is often perceived as "unholy" or "evil". Some aspects such as necromancy and demon summoning are highly regulated or illegal in many regions.|
|Shamanism, Spirit Pacts, Animal Summoning||Unregulated|The the binding of once humanoid spirits is generally considered equivelant to creation of the undead.|
...
|Time Manipulation, Stasis, Aging||Strongly Regulated|Control over time is considered extremely dangerous with potential for catastrophic consequences. Most time manipulation spells are highly regulated, with severe penalties for misuse.|
...
### Any Elemental
Spells that can be cast using any elemental school. The element used will affect the spell's appearance and may have minor mechanical differences based on the element chosen, but the core effect remains the same.

|Spell Name|Description|Comments|
|----------|-----------|--------|
|Bolt|A basic offensive spell that launches a concentrated projectile of elemental energy at a target.|Common starting spell for many mages.|
|Elemental Shield|Creates a protective barrier of the given element around the caster or an ally, deflecting incoming attacks. Especially effective against opposing elements.|Useful for defense in combat.|
|Summon Elemental|Summons a elemental creature to aid the caster the power of the elemental is based on the caster's power.|Elementals will serve for one year or until a specific condition is met.|
...
|Spell Name|Description|Comments|
|----------|-----------|--------|
|Shadow Step|Allows the caster to quickly teleport short distances (line of sight) through shadows.|Useful for stealth and evasion.|
|Curse|Inflicts a target with bad luck or misfortune, hindering their actions.|Commonly used in combat to weaken enemies.|
|Darkness|Creates an area of magical darkness, obscuring vision.|Useful for stealth and escape.|
|Animate Dead|Raises a corpse as an undead servant under the caster's control.|HIGHLY REGULATED or ILLEGAL in many regions.|
|Sicken|Inflicts a target with nausea and weakness, impairing their ability to fight.|Commonly used in combat to debilitate enemies.|
|Drain Life|Saps the life force from a target, healing the caster.||
|Putrefy|Causes organic material to decay rapidly, damaging living targets or degrading objects.||
|Shadow Servants|Creates a shadowy, human forms that can follow simple commands perform light tasks and distract enemies. Will dissipate if attacked or after a short time.|Useful for utility and convenience.|
|Black Tentacles|Summons writhing shadowy tentacles that can grapple and restrain targets within an area.|Useful for crowd control and battlefield manipulation.|
|Summon Shadow|Summons a shadow elemental to aid the caster the power of the elemental is based on the caster's power.|Elementals will serve for one year or until a specific conditions are met.|
|Summon Demon|Summons and restrains a demon allowing the caster to negotiate a contract. If a contract is not made within 666 minutes the demon will be returned to its realm.|HIGHLY REGULATED or ILLEGAL in many regions.|
|Lichdom|The process of transforming oneself into a lich, an undead spellcaster who has achieved immortality through dark magic. The process is long and requires the sacrifice of at least 666 innocent souls, thus the process is always considered illegal and immoral.|ILLEGAL nearly everywhere.|
|Bane|Empowers the caster's weapon with unholy energy, dealing extra damage to living creatures.|Commonly used by dark knights and unholy warriors.|

### Earth
|Spell Name|Description|Comments|
|----------|-----------|--------|
|Gravity Well|Creates a localized area of increased gravity, pulling objects and creatures towards a central point.|Useful for crowd control and battlefield manipulation.|
|Stone Skin|Hardens the caster's skin to the toughness of stone, providing increased protection.|Useful for defense in combat.|
|Earthquake|Causes the ground to shake violently, knocking down and disorienting creatures in the area.|Requires significant magical power to cast.|
|Entomb|Encases a target in solid earth or stone, immobilizing them.|Useful for capturing or restraining enemies.|
|Entangle|Causes plants or roots to grow rapidly, ensnaring and immobilizing a target.|Useful for crowd control and battlefield manipulation.|
|Dig|Allows the caster to tunnel through earth and stone.|Useful for escape or infiltration.|
|Wall of Stone|Creates a solid wall of stone that can be used for defense or to block passage.|Useful for creating barriers and fortifications.|

### Air
|Spell Name|Description|Comments|
|----------|-----------|--------|
|Fly|Allows the caster to levitate or fly for a short duration.|Useful for exploration and evasion.|
|Gust|Creates a powerful blast of wind that can knock back enemies or objects.|Useful for crowd control and battlefield manipulation.|
...
|Desicate|Dries out moisture from a target, causing dehydration and weakening them.|Useful for weakening enemies.|
...
|Spell Name|Description|Comments|
|----------|-----------|--------|
|Spirit Walk|Allows the caster to temporarily leave their physical body and explore the spirit realm.|Useful for gathering information and communicating with spirits.|
|Spirit Bind|Binds a spirit to an object or location, allowing it to serve the caster.|HIGHLY REGULATED or ILLEGAL in many regions if the spirit was once humanoid.|
|Animal Companion|Summons a loyal animal companion to aid the caster.|The bond with the animal is strong and lasts indefinitely. The caster may have a limited number of animal companions based on their power level.|
|Totem|Creates a magical totem that provides various benefits to the caster and their allies.|The totem's effects depend on the type of totem created.|
...
|Charm|Influences the emotions and attitudes of a target, making them more friendly or cooperative.|Commonly used in social situations. Highly regulated in many areas.|
...
|Reverse Aging|Restores youth to a target by reversing their aging process.||
