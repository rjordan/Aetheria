...
class AetheriaHttpServer {
    ...
    async getHierarchyEntity(req, res) {
        try {
...
<body>
    ...
    findEntityInHierarchy(data, entityName) {
        const search = (obj) => {
    ...
    getParentChain(data, entityName) {
